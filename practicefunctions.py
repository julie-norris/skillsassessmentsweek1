...
# I had to look in wikipedia to remember how to use the modulo because I didn't 
#know where to find it or if it had been covered in the class notes. I had written
# it like this: num/3 % 0 instead of num % 3 == 0
...
def num_spaces(sentence):
    ...
    for space in sentence:
        if space == " ":
            number_of_spaces = int(number_of_spaces) + 1
